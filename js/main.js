(function () {
  ...
  const translations = {
    en: {
      ...
      "nav.home": "Home",
      "home.title": "My Work",
      "home.subtitle": "Fiction, analytical writing, applied research, and workshops on AI",
      "home.body1": "Hi, I’m Camilo. This site brings together my most recent work.",
      "home.body2": "Writing is at the center of what I do. I develop <strong>long-form fiction</strong> and write <strong>essays and technical pieces</strong> that combine <strong>observation, evidence, structure, and precision</strong>.",
      "home.body3": "<strong>Artificial intelligence</strong> is one of my areas of research. I am less interested in what these systems promise than in <strong>what they actually do</strong>: how they behave in practice, under what conditions they work, and where their limitations emerge.",
      "home.body4": "I also design <strong>workshops for professionals and teams</strong> who want to integrate AI into <strong>writing, research, review, and documentation</strong> without losing control over <strong>judgment or final decisions</strong>.",
      "home.letters.title": "Letters from Masaya",
      "home.letters.body": "I share a personal letter, once a week.",
      "home.letters.link": "Subscribe",
      "bio.title": "Bio",
      ...
      "contact.letters.title": "Letters from Masaya",
      "contact.letters.body": "I share a personal letter, once a week.",
      "contact.letters.link": "Subscribe",
    ...
    es: {
      ...
      "home.subtitle": "Ficción, escritura analítica, investigación aplicada y talleres sobre IA",
      "home.body1": "Hola, soy Camilo. Este sitio reúne mi trabajo más reciente.",
      "home.body2": "La escritura es el centro de lo que hago. Desarrollo <strong>ficción narrativa de largo aliento</strong> y escribo <strong>ensayos y piezas técnicas</strong> donde combino <strong>observación, evidencia, estructura y precisión</strong>.",
      "home.body3": "La <strong>inteligencia artificial</strong> es uno de mis campos de investigación. Me interesa menos lo que estos sistemas prometen que <strong>lo que realmente hacen</strong>: cómo se comportan en la práctica, bajo qué condiciones funcionan y dónde aparecen sus límites.",
      "home.body4": "También diseño <strong>talleres para profesionales y equipos</strong> que quieren integrar la IA en tareas de <strong>redacción, investigación, revisión y documentación</strong> sin perder control sobre <strong>el criterio ni las decisiones finales</strong>.",
      "home.letters.title": "Letters from Masaya",
      "home.letters.body": "Comparto una carta personal, una vez por semana.",
      "home.letters.link": "Suscríbete",
      "bio.title": "Bio",
      ...
      "contact.letters.title": "Letters from Masaya",
      "contact.letters.body": "Comparto una carta personal, una vez por semana.",
      "contact.letters.link": "Suscríbete",
